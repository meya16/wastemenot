...
public class TinyDB {
    ...
    public ArrayList<Integer> getListInt(String key) {
        String[] myList = TextUtils.split(preferences.getString(key, "1"), "‚‗‚");
    ...
    public ArrayList<PopularDemon> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PopularDemon> playerList =  new ArrayList<PopularDemon>();

        for(String jObjString : objStrings){
            PopularDemon player  = gson.fromJson(jObjString,  PopularDemon.class);
    ...
    public void putListObject(String key, ArrayList<PopularDemon> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PopularDemon player: playerList){
